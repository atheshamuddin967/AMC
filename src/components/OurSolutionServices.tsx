          ...
          <h2 className="text-4xl md:text-5xl font-extrabold">
            Our Products
              ...
              <p className="text-lg text-gray-600 mt-3">
               ...
               Our products are designed with quality, innovation, and reliability in mind. 
    Every solution we offer is created to make life easier, more efficient, 
    and adaptable to your unique needs. Explore our range and discover what fits you best.
  
          </p>
          <div className="w-20 h-1 bg-background2 mx-auto mt-5 rounded-full" />
        </div>

        {/* Portable Solar Solution Section */}
        <section className="w-full py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-xl md:text-2xl font-semiBold mb-2">            Solar Power — Anytime and Anywhere!
</p>
        ...
        {/* Solar Storage Solution Section */}
